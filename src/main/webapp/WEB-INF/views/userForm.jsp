            ...
            <div class="container w-25">
             ...
             <form:form method="POST" modelAttribute="user" class="padding-small text-center">
                    ...
                    <div class="form-group">
                        <form:input path="username" type="text" class="form-control" placeholder="Nazwa użytkownika"/>
                    </div>
                    <div class="form-group">
                        <form:input path="password" type="password" class="form-control" placeholder="Podaj hasło"/>
                    </div>
                 <button class="btn btn-color rounded-0" type="submit">Załóż konto</button>
             </form:form>
            </div>
        </div>
    </div>
