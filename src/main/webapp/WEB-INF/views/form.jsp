    ...
    <div class="form__div">
        <form:form class="form form--bill" method="POST" modelAttribute="bill">
           <div class="form__div--label">
                           <a href="http://localhost:8080/accounts/menu" class="form__anchor">
                              <label class="form__label--app">Menu</label>
                           </a>
                       </div>
                       <div class="form__div--label">
                           <label class="form__label">
                               <strong>Dodaj</strong> nową fakturę
                           </label>
                       </div>
                       <div class="form__div--input">
                           <label class="form__label">
                               <form:input path="number" class="form__input" type="text" placeholder="Numer faktury"/>
                           </label>
                       </div>
                       <div class="form__div--input">
                           <label class="form__label">
                               <form:input path="nameContractor" class="form__input" type="text" placeholder="Nazwa firmy"/>
                           </label>
                       </div>
                       <div class="form__div--input">
                           <label class="form__label">
                       ...
                       <div class="form__div--input">
                           <label class="form__label">
                               <form:input path="date" class="form__input form__input--date" type="date" placeholder="Data"/>
                           </label>
                       </div>
                       <div class="form__div--input">
                       ...
                       <div class="form__div--label">
                           <button class="form__button" type="submit"> ZAPISZ FAKTURĘ </button>
                       </div>
        </form:form>
    </div>
</body>
